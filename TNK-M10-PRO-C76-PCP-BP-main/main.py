...
try:    
    ...
    if prediction < 0.5:
        infected = cv2.putText(img, str(int, prediction[0][0], (X, Y), cv2.FONT_HERSHEY_COMPLEX, 1, (255, 0, 255), 2))
    else:
       uninfected = cv2.putText(img, str(int, prediction[0][0], (X, Y), cv2.FONT_HERSHEY_COMPLEX, 1, (255, 0, 255), 2))
